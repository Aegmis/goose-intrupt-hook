...
### Added
- goose `PreToolUse` Open-Plugins hook (Python) that gates **developer__shell / developer__text_editor** behind a human Slack approval via the Aegmis
  ...
  Block signal: exit 2 + `{"decision":"block"}`.
